...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="../../../images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：后台管理 &gt; 添加活动</td>
        <td width="15" height="32"><img src="../../../images/main_locright.gif" width="15" height="32"></td>
    </tr>
</table>
<div style="width: 100%;border:1px solid #c2c6cc;background-color: #f5f7fa">
    <form action="addActivity" id="activityForm" method="post">
        <!-- 隐藏表单，flag表示添加标记 -->
        <input type="hidden" name="flag" value="2">
        <table style="width: 500px;margin: 30px;border: 1px;">
            <tr style="height: 60px;">
                <td>活动标题<input type="text" name="actTitle" id="actTitle"></td>
                <td>活动发起者id<input type="text" name="sponsorId" id="sponsorId"></td>
            </tr>

            <tr style="height: 60px;">
                <td>活动内容<input type="text" name="actContent" id="actContent"></td>
                <td>
                    <div class="form-group">
                        活动类型
                        <select id="type" class="selectpicker" data-live-search="true" title="吃饭" name="type">
                            <option>吃饭</option>
                            <option>运动</option>
                            <option>桌游</option>
                            <option>开黑</option>
            ...
            <tr style="height: 60px;">
                <td>活动状态<input type="text" name="stat" id="stat"></td>
                <td>截止时间
