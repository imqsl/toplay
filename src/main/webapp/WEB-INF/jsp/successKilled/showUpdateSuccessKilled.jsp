...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="../../../images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：后台管理 &gt; 修改秒杀详情</td>
        <td width="15" height="32"><img src="../../../images/main_locright.gif" width="15" height="32"></td>
    </tr>
</table>
<div style="width: 100%;border:1px solid #c2c6cc;background-color: #f5f7fa">
    <form action="updateSuccessKilled" id="successKilledForm" method="post">
        <!-- 隐藏表单，flag表示添加标记 -->
        <input type="hidden" name="flag" value="2">
        <input type="hidden" name="id" value="${successKilled.id}">
        <table style="width: 500px;margin: 30px;">
            <tr style="height: 60px;">
                <td>秒杀id<input type="text" name="seckillId" id="seckillId" value="${successKilled.seckillId}"></td>
            </tr>

            <tr style="height: 60px;">
                <td>用户id<input type="text" name="userId" id="userId" value="${successKilled.userId}"></td>
            </tr>

            <tr style="height: 60px;">
                <td>
                    <div class="form-group">状态:
                        <select id="stat" class="selectpicker" data-live-search="true" title="${successKilled.stat}"
                                name="stat" value="${successKilled.stat}">
                            <option>1</option>
                            <option>0</option>
                        </select>
                    </div>
