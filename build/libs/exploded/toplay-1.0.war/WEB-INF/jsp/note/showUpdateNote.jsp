...
<div style="width: 100%;border:1px solid #c2c6cc;background-color: #f5f7fa">
    <form action="updateNote" id="noteForm" method="post">
        <!-- 隐藏表单，flag表示添加标记 -->
        <input type="hidden" name="flag" value="2">
        <input type="hidden" name="id" value="${note.id}">
        <table  style="width: 500px;margin: 30px;">
            <tr style="height: 60px;">
                <td>标题<div></div><input type="text" name="title" id="title" value="${note.title}"></td>
            </tr>
            <tr style="height: 60px;">
                <td >内容<div></div><input type="text" name="content" id="content" value="${note.content}"></td>
            </tr>
            <tr style="height: 60px;">
                <td >类型
                    <div class="form-group">
                        <select id="type" class="selectpicker" data-live-search="true" title="${note.type}" name="type" value="${note.type}">
                            <option>系统通知</option>
                            <option>好消息</option>
                            <option>其他</option>
                        </select>
        ...
        <div style="width: 100%; height: 100px; border-top: 1px dashed #c2c6cc">
            <input type="submit" value="提交" class="btn btn-default" style="margin-left:100px; margin-top: 10px;">
