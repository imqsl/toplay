...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="../../../images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：后台管理 &gt; 修改秒杀</td>
        <td width="15" height="32"><img src="../../../images/main_locright.gif" width="15" height="32"></td>
    </tr>
</table>
<div style="width: 100%;border:1px solid #c2c6cc;background-color: #f5f7fa">
    <form action="updateSeckill" id="seckillForm" method="post">
        <input type="hidden" name="flag" value="2">
        <input type="hidden" name="id" value="${seckill.id }">
        <table style="width: 500px;margin: 30px;">
            <tr style="height: 60px;">
                <td>商品名<input type="text" name="name" id="name" value="${seckill.name}"></td>
                <td>价格<input type="text" name="price" id="price" value="${seckill.price}"></td>
                <td>数量<input type="text" name="seckillNumber" id="seckillNumber" value="${seckill.seckillNumber}"></td>
            </tr>
            <tr style="height: 60px;">
                <td>开始时间
                    <div id="datetimepicker" class="input-append date">
                        <input type="text"
                               value="<f:formatDate value="${seckill.startTime}" type="both" dateStyle="medium"/>"
                               name="startTime" id="startTime"></input>
                        <span class="add-on">
        <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                ...
                <td>结束时间
                    <div id="datetimepicker2" class="input-append date">
                        <input type="text"
                               value="<f:formatDate value="${seckill.endTime}" type="both" dateStyle="medium"/>"
                               name="endTime" id="endTime"></input>
                        <span class="add-on">
        <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
      </span>
                    </div>
